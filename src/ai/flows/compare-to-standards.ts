 ...
 *
 * - compareToStandards - A function that compares a clause to standards.
...
const CompareToStandardsInputSchema = z.object({
  clause: z.string().describe('The clause to compare to regional and industry standards.'),
  documentType: z
    .string()
    .describe(
...
const CompareToStandardsOutputSchema = z.object({
  comparison: z.string().describe('A comparison of the clause to regional and industry standards.'),
  isStandard: z
    .boolean()
    .describe(
  ...
  rationale: z
    .string()
    .describe('The rationale for why the clause is considered standard or not.'),
});
